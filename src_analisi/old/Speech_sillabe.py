...
if __name__ == "__main__":
    ...
    main_classification(X_df, X_train, X_test, y_train, y_test, 'speech_sillabe.xlsx')
    ...
    als_df = remove_columns(als_df_complete, columns_to_drop)
    X_df, X_train, X_test, y_train, y_test = prepare_data(als_df, y)
    main_classification(X_df, X_train, X_test, y_train, y_test, 'speech_noMFCCs_sillabe.xlsx')