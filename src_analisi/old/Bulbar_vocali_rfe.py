...
def main_regression(df, y, name_file, results, results_prediction, results_name):
    ...
    for indx, (train_idx, test_idx) in enumerate(train_test_split.split(X, y)):
        ...
        if indx < 38:  # Skip the first 38 folds
            continue
...
if __name__ == "__main__":
    ...
    main_regression(als_df, y, 'bulbar_LOO_vocali_rfe.xlsx', results, results_prediction, 'results_vocali.xlsx')
    ...
    als_df = remove_columns(als_df_complete, columns_to_drop)
    main_regression(als_df, y, 'bulbar_noMFCCs_LOO_vocali_rfe.xlsx', results, results_prediction, 'results_noMFCCs_vocali.xlsx')