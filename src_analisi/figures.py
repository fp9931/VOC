...
# ########################################### CLASSIFICATION ##############################################################
# general_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
# results_path = os.path.join(general_path, 'Results/Risultati da presentare/Classification/First dataset')

# df_sep = pd.read_excel(os.path.join(results_path, 'SEP 1.xlsx'))
