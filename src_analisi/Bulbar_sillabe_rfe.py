...
if __name__ == "__main__":
    ...
    main_regression(als_df, y, 'bulbar_LOO_sillabe_rfe.xlsx', results, results_prediction, 'results_sillabe.xlsx')
    ...
    als_df = remove_columns(als_df_complete, columns_to_drop)
    main_regression(als_df, y, 'bulbar_noMFCCs_LOO_sillabe_rfe.xlsx', results, results_prediction, 'results_noMFCCs_sillabe.xlsx')