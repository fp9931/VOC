...
syllabels.to_excel(os.path.join(general_path, "Features", "Features_syllables.xlsx"), index=False) 

vowels = results_vow_df.apply(add_suffix, axis=1)
vowels = vowels.groupby("ID", as_index=False).first()
vowels.to_excel(os.path.join(general_path, "Features", "Features_vowels.xlsx"), index=False)
